...
{
	vector<string> v;
	v.push_back("Nilay"); v.push_back("10.145.213.42"); v.push_back("6790");
	user_info.push_back(v);
	v.clear();
	v.push_back("Surya"); v.push_back("10.145.184.24"); v.push_back("6789");
	user_info.push_back(v);
            ...
            // Else check if the host is already connected
         	...
         	{	  
    		  	...
    		  	bcopy((char *)peer->h_addr, 
         	  	...
         	  	peer->h_length);
    	      	peer_addr.sin_port = htons(atoi(user_info[i][2].c_str()));
